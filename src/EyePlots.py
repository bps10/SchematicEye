...
# Seperate analyses into seperate functions     
...
class EyePlot():
    ...
    def EncircledIntensityPlot(self):
        ...
        print self.samples, len(self.xvals), self.Intensity['intensity'][0,:].shape
        for i in range(0, 4):
