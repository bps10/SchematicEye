/* Generated by Cython 0.17.2 on Tue Jun 25 16:09:02 2013 */
...
static PyObject *__pyx_pf_3eye_py_eye(CYTHON_UNUSED PyObject *__pyx_self, float __pyx_v_object_distance, float __pyx_v_off_axis, float __pyx_v_pupil_size, float __pyx_v_diopters); /* proto */
...
static PyObject *__pyx_pw_3eye_1py_eye(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s__object_distance,&__pyx_n_s__off_axis,&__pyx_n_s__pupil_size,&__pyx_n_s__diopters,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s__off_axis)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("py_eye", 1, 4, 4, 1); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 62; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  2:
        if (likely((values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s__pupil_size)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("py_eye", 1, 4, 4, 2); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 62; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  3:
        if (likely((values[3] = PyDict_GetItem(__pyx_kwds, __pyx_n_s__diopters)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("py_eye", 1, 4, 4, 3); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 62; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
      }
  ...
  __Pyx_RaiseArgtupleInvalid("py_eye", 1, 4, 4, PyTuple_GET_SIZE(__pyx_args)); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 62; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  __pyx_L3_error:;
  __Pyx_AddTraceback("eye.py_eye", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_3eye_py_eye(__pyx_self, __pyx_v_object_distance, __pyx_v_off_axis, __pyx_v_pupil_size, __pyx_v_diopters);
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
}
...
static PyObject *__pyx_pf_3eye_py_eye(CYTHON_UNUSED PyObject *__pyx_self, float __pyx_v_object_distance, float __pyx_v_off_axis, float __pyx_v_pupil_size, float __pyx_v_diopters) {
  float *__pyx_v_array;
 ...
 *     size = 399
 */
  __pyx_v_array = SchematicEye::Analysis().IntensityAnalysis(__pyx_v_object_distance, __pyx_v_off_axis, __pyx_v_pupil_size, __pyx_v_diopters);
 ...
 *         not copy the data allocated in C.
 */
  __pyx_k_tuple_13 = PyTuple_New(8); if (unlikely(!__pyx_k_tuple_13)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 62; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  ...
  PyTuple_SET_ITEM(__pyx_k_tuple_13, 4, ((PyObject *)__pyx_n_s__array));
  __Pyx_GIVEREF(((PyObject *)__pyx_n_s__array));
  __Pyx_INCREF(((PyObject *)__pyx_n_s__ndarray));
  PyTuple_SET_ITEM(__pyx_k_tuple_13, 5, ((PyObject *)__pyx_n_s__ndarray));
  __Pyx_GIVEREF(((PyObject *)__pyx_n_s__ndarray));
  __Pyx_INCREF(((PyObject *)__pyx_n_s__size));
  PyTuple_SET_ITEM(__pyx_k_tuple_13, 6, ((PyObject *)__pyx_n_s__size));
  __Pyx_GIVEREF(((PyObject *)__pyx_n_s__size));
  __Pyx_INCREF(((PyObject *)__pyx_n_s__array_wrapper));
  PyTuple_SET_ITEM(__pyx_k_tuple_13, 7, ((PyObject *)__pyx_n_s__array_wrapper));
